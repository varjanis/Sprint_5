...
def test_redirect_from_personal_cabinet_to_constructor_via_constructor_button_success(driver):
    ...
    driver.find_element(By.XPATH, './/header/nav/ul/li/a/p').click()
    time.sleep(5)
...
def test_redirect_from_personal_cabinet_to_constructor_via_burger_logo(driver):
